...
echo "\n--> Syncing .html"
s3cmd sync --acl-public --mime-type="text/html; charset=utf-8" --exclude '*.*' --include  '*.html' --add-header="Cache-Control: max-age=60, must-revalidate"  _site/ s3://runemadsen.com
