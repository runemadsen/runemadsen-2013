...
<img src="{% asset_path printing-code/grid/apple_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/apple.jpg %}" />

<img src="{% asset_path printing-code/grid/mondrianRULES_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/mondrianRULES.jpg %}" />
...
<img src="{% asset_path printing-code/grid/gridhistory1_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gridhistory1.jpg %}" />
...
<img src="{% asset_path printing-code/grid/gridhistory2_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gridhistory2.jpg %}" />
...
<img src="{% asset_path printing-code/grid/gridhistory3_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gridhistory3.jpg %}" />
...
<img src="{% asset_path printing-code/grid/gridhistory4_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gridhistory4.jpg %}" />

The masters of the grid system - Swiss Style designers like Brockmann and Gerstner.

<img src="{% asset_path printing-code/grid/brockmann_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/brockmann.jpg %}" />

<img src="{% asset_path printing-code/grid/swiss_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/swiss.jpg %}" />

<img src="{% asset_path printing-code/grid/swiss2_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/swiss2.jpg %}" />

<img src="{% asset_path printing-code/grid/gerstner_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gerstner.jpg %}" />
...
<img src="{% asset_path printing-code/grid/grid_manuscript_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid_manuscript.jpg %}" />
...
<img src="{% asset_path printing-code/grid/grid_column_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid_column.jpg %}" />
...
<img src="{% asset_path printing-code/grid/grid_modular_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid_modular.jpg %}" />
...
<img src="{% asset_path printing-code/grid/grid_hierarchical_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid_hierarchical.jpg %}" />
...
<img src="{% asset_path printing-code/grid/brockmanngrid_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/brockmanngrid.jpg %}" />

<img src="{% asset_path printing-code/grid/brockmanngrid2_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/brockmanngrid2.jpg %}" />

<img src="{% asset_path printing-code/grid/grid1.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid1.jpg %}" />

<img src="{% asset_path printing-code/grid/grid2_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid2.jpg %}" />

<img src="{% asset_path printing-code/grid/grid3.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid3.jpg %}" />

<img src="{% asset_path printing-code/grid/grid4_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid4.jpg %}" />
...
<img src="{% asset_path printing-code/grid/grid_modular_filled1_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid_modular_filled1.jpg %}" />

<img src="{% asset_path printing-code/grid/grid_modular_filled2_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid_modular_filled2.jpg %}" />

<img src="{% asset_path printing-code/grid/grid_modular_filled3_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid_modular_filled3.jpg %}" />
...
<img src="{% asset_path printing-code/grid/wrong_calculations_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/wrong_calculations.jpg %}" />
...
<img src="{% asset_path printing-code/grid/grid_manuscript_example_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid_manuscript_example.jpg %}" />
...
<img src="{% asset_path printing-code/grid/manuscript_grid_circles_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/manuscript_grid_circles.png %}" />
...
<img src="{% asset_path printing-code/grid/grid_column_example_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid_column_example.jpg %}" />
[Example on Github](https://github.com/runemadsen/printing-code/tree/master/code/grid/column_grid)

<img src="{% asset_path printing-code/grid/grid_column_random_example_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid_column_random_example.jpg %}" />
...
<img src="{% asset_path printing-code/grid/column_grid_circles_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/column_grid_circles.png %}" />
...
<img src="{% asset_path printing-code/grid/grid_modular_example_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid_modular_example.jpg %}" />
...
<img src="{% asset_path printing-code/grid/modular_grid_circles_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/modular_grid_circles.png %}" />
...
<img src="{% asset_path printing-code/grid/grid_no_overlap_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid_no_overlap.jpg %}" />
...
<img src="{% asset_path printing-code/grid/gerstner0_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gerstner0.jpg %}" />

<img src="{% asset_path printing-code/grid/gerstner1_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gerstner1.jpg %}" />

<img src="{% asset_path printing-code/grid/gerstner2_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gerstner2.jpg %}" />

<img src="{% asset_path printing-code/grid/gerstner3_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gerstner3.jpg %}" />

<img src="{% asset_path printing-code/grid/gerstner4_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gerstner4.jpg %}" />

<img src="{% asset_path printing-code/grid/gerstner5_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gerstner5.jpg %}" />

<img src="{% asset_path printing-code/grid/gerstner6_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gerstner7.jpg %}" />

<img src="{% asset_path printing-code/grid/gerstner8_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gerstner8.jpg %}" />

<img src="{% asset_path printing-code/grid/gerstner9_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gerstner9.jpg %}" />
...
<img src="{% asset_path printing-code/grid/gerstner_capital1_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gerstner_capital1.jpg %}" />

<img src="{% asset_path printing-code/grid/gerstner_capital2_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gerstner_capital2.jpg %}" />

<img src="{% asset_path printing-code/grid/gerstner_capital3_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gerstner_capital3.jpg %}" />

<img src="{% asset_path printing-code/grid/gerstner_capital4_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gerstner_capital4.jpg %}" />

<img src="{% asset_path printing-code/grid/gerstner_capital5_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gerstner_capital5.jpg %}" />

<img src="{% asset_path printing-code/grid/gerstner_capital6_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gerstner_capital6.jpg %}" />

<img src="{% asset_path printing-code/grid/gerstner_capital7_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gerstner_capital7.jpg %}" />

<img src="{% asset_path printing-code/grid/gerstner_capital8_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gerstner_capital8.jpg %}" />

<img src="{% asset_path printing-code/grid/gerstner_capital9_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/gerstner_capital9.jpg %}" />
...
<img src="{% asset_path printing-code/grid/grid_multiple_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid_multiple.jpg %}" />

<img src="{% asset_path printing-code/grid/grid_multiple2_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid_multiple2.jpg %}" />
...
<img src="{% asset_path printing-code/grid/grid_multiple_bruce_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid_multiple_bruce.jpg %}" />
...
<img src="{% asset_path printing-code/grid/grid_modular_random_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid_modular_random.jpg %}" />

<img src="{% asset_path printing-code/grid/grid_modular_random2_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid_modular_random2.jpg %}" />

<img src="{% asset_path printing-code/grid/grid_modular_random3_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/grid_modular_random3.jpg %}" />
...
<img src="{% asset_path printing-code/grid/random_columns_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/random_columns.jpg %}" />
	
<img src="{% asset_path printing-code/grid/random_columns2_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/random_columns2.jpg %}" />
	
<img src="{% asset_path printing-code/grid/random_columns3_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/random_columns3.jpg %}" />
...
<img src="{% asset_path printing-code/grid/random_grid5_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/random_grid5.jpg %}" />

<img src="{% asset_path printing-code/grid/random_grid6_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/random_grid6.jpg %}" />

<img src="{% asset_path printing-code/grid/random_grid4_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/random_grid4.jpg %}" />

<img src="{% asset_path printing-code/grid/random_grid_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/random_grid.jpg %}" />

<img src="{% asset_path printing-code/grid/random_grid2_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/random_grid2.jpg %}" />

<img src="{% asset_path printing-code/grid/random_grid3_small.jpg %}" data-slideshow="{% asset_path printing-code/grid/random_grid3.jpg %}" />
